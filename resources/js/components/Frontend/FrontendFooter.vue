        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="lg:col-span-2">
                    <div class="flex items-center space-x-3 mb-6">
                        <div class="w-12 h-12 flex items-center justify-center shadow-sm">
                            <img src="/image/LOGO TOSCA.png" alt="JustTrip Logo" class="w-10 h-10 object-contain">
                        </div>
                        <div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li>
                            <Link href="/" class="text-gray-300 hover:text-white transition-colors duration-200 flex items-center">
            ...
            <div class="border-t border-white/10 mt-8 pt-8 text-center">
                <p class="text-gray-400 text-sm">
                    © {{ new Date().getFullYear() }} Justtrip. All rights reserved. Made with ❤️ for your journey.
                </p>
            </div>
        </div>
    </footer>
